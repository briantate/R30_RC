...
void TransceiverConfig(void) {
  ...
  /*Pins  PA12/RFCTRL2 and PA09/RFCTRL1 are used as DIG1 and DIG2 pins
   * respectively in SAMR30 Xplained Pro*/
  ...
  /*MUX Position is 'F' i.e 5 for FECTRL Function and is same for all  FECTRL
   * supported pins as provided in the data sheet */
